...
void Car::readFromConsole()
{
    ...
    cout << "Введите марку машины: "; cin >> _mark;
    cout << "Введите цвет машины: "; cin >> _color;
    cout << "Введите тип кузова машины: "; cin >> _bodyType;
    cout << "Введите объём двигателя:  машины: "; cin >> _engineValue;
    cout << "Введите пробег машины: "; cin >> _mileage;
}
